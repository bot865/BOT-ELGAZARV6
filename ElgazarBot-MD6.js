...
"لو خيروك |  بين مشاركة المنزل مع عائلة من الفئران أو عائلة من الأشخاص المزعجين الفضوليين الذين يتدخلون في كل كبيرة وصغيرة؟ ",
              ...
              buffertruth = await getBuffer(`https://telegra.ph/file/666f347726644b3f59504.mp4`)
...
"‏مامن لسان يستغفر إلا فتحت له الدنيا بما فيها أستغفرك ربي وأتوب إليك "
              ...
              buffertruth1 = await getBuffer(`https://telegra.ph/file/666f347726644b3f59504.mp4`)
...
"أنِر ظُلمتي، وامحُ خطيئتي، واقبل توبتي وأعتِق رقبتي يا اللّٰه. إنكَ عفوٌّ تُحِبُّ العفوَ؛ فاعفُ عني 💛 ",
              ...
              bufferhfuduf = await getBuffer(`https://telegra.ph/file/666f347726644b3f59504.mp4`)
    ...
    "『فيجيتا』","『غوكو』","『شيسوي』","『ايتاشي』","『ناروتو』","『كيلوا』","『لوفي زورو سانجي』","『زاراكي ايزن توسين』","『ناروتو ساسكي كاكاشي』","『مادارا اوبيتو』","『هاشيراما توبيراما』","『انزاي دازاي』","『هاغومورو』","『سوكونا يوجي』","『كاكاشي هاتاكي』","『فوغاكو اوتشيها』","『ناروتو اوزوماكي』","『غارب لوفي ايس ساب』و","『اكاينو اوكيجي كيزارو』","『غون كيلوا』","『اوميني』","『سيلفا زينو نيترو』","『استا يامي』","『كيسكي يوروتشي ايتشيغو』","『ساروتوبي دانزو』","『فوجيتورا』","『نامي روبين』","『هيماواري هينات』","『ستارك جريمجو نيل』","『الوكا』","『شينو كيبا』","『روك لي مايت غاي』","『ايتاشي ساسكي』","『كونان ناغاتو ياهيكو』","『جيرايا تسونادي』","『ساي اينو』","『شينرا』","『ثوركيل ثورفين ثورز』","『اشيلاد』","『لاو ميهوك زورو』","『تيتش ادوارد』","『ناكا اوتشيها』","『هيروزين ساروتوبي』","『مونكي دي لوفي』","『كارين』","『موريا』","『اشورا هامورا』","『انيوشا كاجومي』","『ديدارا ساسوري』","『روجر رايلي』","『تانجيرو نيزيكو』","『زينيتسو اينوسكي』","『زيك ايرين』","『ميكاسا اني』","『ليفاي اكيرمان』","『ايروين مايكي』","『مايكي دراكن』","『هيسوكا』","『ارمين』","『هاتسوني ميكو』","『كورو』","『اوراهارا كيسكي』","『شينوبو كاناو』","『كيسامي اكاشي』","『كوزان』",
              ...
              buffergmscat = await getBuffer(`https://telegra.ph/file/666f347726644b3f59504.mp4`)
...
" كنت نصحت نفسي ياخويا😹",
              ...
              bufferisjshsd = await getBuffer(`https://telegra.ph/file/666f347726644b3f59504.mp4`)
...
"دولة واسم بحرف ⤌ ب  ",
              ...
              bufferidhsisgd = await getBuffer(`https://telegra.ph/file/666f347726644b3f59504.mp4`)
...
case 'how': {
            ...
            break
case 'الغباء': {
            	if (!text) throw `مثال : ${prefix + command} بوت`
...
case 'بوت': {
            ...
            break
case 'الحب':
				if (!text) return m.reply(`منشن علي شخص, مثال : ${prefix + command} @ELAKRAB`)
...
ElgazarBot.sendMessage(from, { text: `*${command}*\n\nالاسم : ${q}\nالاجابه : *${teng}%*` }, { quoted: m })
					...
					break
case 'الكره':
				if (!text) return m.reply(`منشن علي شخص, مثال : ${prefix + command} @elakreb`)
...
ElgazarBot.sendMessage(from, { text: `*${command}*\n\nالاسم : ${q}\nالاجابه : *${sange}%*` }, { quoted: m })
      ...
      case 'اهطل': {
            ...
            let me = m.sender
            let jodoh = member[Math.floor(Math.random() * member.length)]
            let jawab = `الراجل دا توب التوب *${command}* في الجروب @${jodoh.split('@')[0]}`
            let ments = [me, jodoh]
            let buttons = [
...
if (args.length === 0) throw `أين الرابط?\nارسل ${prefix + command} والرابط`
        ...
        if (!(urlInsta.includes("instagram.com/p/") ||
            ...
            return ElgazarBot.sendMessage(
                m.chat,
                { text: `الرابط الي بعتو مش رابط انستجرام` },
                { quoted: m }
            );      
...
let buttonMessage = {
image: {url: `https://telegra.ph/file/666f347726644b3f59504.mp4`},
jpegThumbnail: log0,
caption: teks,
footer: `${botname}`,
buttons: buttons,
...
mediaType:1,
mediaUrl: 'https://telegra.ph/file/666f347726644b3f59504.mp4',
sourceUrl: "https://telegra.ph/file/666f347726644b3f59504.mp4"
}}
}
ElgazarBot.sendMessage(m.chat, buttonMessage, { quoted: m })
}
...
• انا بوت واتس اسمي ⤌⤈
𓆩 *${global.botname}* 𓆪
• تم صنع هذا البوت بواسطه العقرب اليوتيوبر 
 
كل ما يخص المطور العقرب اليوتيوبر 
...
"businessOwnerJid": "201028085788@s.whatsapp.net",
}
}), { userJid: m.chat, quoted: doc })
ElgazarBot.relayMessage(m.chat, catalog.message, { messageId: catalog.key.id })
}
...
"message": ownername,
"orderTitle": wm, // 
"sellerJid": " 201028085788@s.whatsapp.net",
...
case 'م2': case 'اوامر المطور': {
teks = `• مرحبا ياقلبي ⤌⤈       
𓆩 *${pushname}* 𓆪
𓍹——————————𓍻
 🌿 خد قائمة باوامر المالك𓆪
𓍹——————————𓍻
( .عام )
...
let buttonMessage = {
video: {url: `https://telegra.ph/file/666f347726644b3f59504.mp4`},
jpegThumbnail: log0,
caption: teks,
footer: `${botname}`,
buttons: buttons,
